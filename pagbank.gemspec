...
require_relative "lib/pagbank/version"

Gem::Specification.new do |spec|
  spec.name          = "pagbank"
  spec.version       = Pagbank::VERSION
  spec.authors       = ["João Pedro"]
  spec.email         = ["hi@joaonetto.me"]

  spec.summary       = "PagBank API for Ruby"
  spec.description   = "Generate PIX transactions via PagBank on Ruby"
  spec.homepage      = "https://github.com/jnettome/pagbank"
  ...
  spec.add_dependency 'cacheable', '~> 2.0.0'
  # spec.add_dependency ''
