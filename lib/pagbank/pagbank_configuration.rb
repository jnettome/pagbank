...
module Pagbank
  ...
  class PagbankConfiguration
    attr_accessor :api_client_id
    attr_accessor :api_client_secret
    attr_accessor :api_test_token
    attr_accessor :api_version
    
    attr_accessor :environment
    
    attr_accessor :certfile
    ...
    def initialize
      @ca_bundle_path = Pagbank::DEFAULT_CA_BUNDLE_PATH
    ...
    def log_level=(val)
      ...
      if val == "debug"
        val = Pagbank::LEVEL_DEBUG
      elsif val == "info"
        val = Pagbank::LEVEL_INFO
      end

      levels = [Pagbank::LEVEL_INFO, Pagbank::LEVEL_DEBUG, Pagbank::LEVEL_ERROR]
